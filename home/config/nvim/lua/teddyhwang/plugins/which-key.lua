...
whichkey.register({
  ...
  g = {
    ...
    l = { "<cmd>GitLink<cr>", "Copy git permlink to clipboard" },
    L = { "<cmd>GitLink!<cr>", "Open git permlink in browser" },
    b = { "<cmd>GitLink blame<cr>", "Copy git blame link to clipboard" },
    B = { "<cmd>GitLink! blame<cr>", "Open git blame link in browser" },
  },
