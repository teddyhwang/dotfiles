...
packages="atuin bash-preexec carapace-bin claude-code git-delta google-chrome herdr keychain keyd lsof nodejs rust seahorse socat tig tmux ttf-firacode-nerd ttf-meslo-nerd yazi zellij zsh"
